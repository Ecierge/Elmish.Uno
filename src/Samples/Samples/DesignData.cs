...
using NewDialog1StaticViewModel = Elmish.Uno.Samples.NewDialogStatic.Dialog1.Dialog1ViewModel;
using NewDialog2StaticViewModel = Elmish.Uno.Samples.NewDialogStatic.Dialog2.Dialog2ViewModel;
using NewDialogStaticViewModel = Elmish.Uno.Samples.NewDialogStatic.NewDialogStaticViewModel;
...
internal class DesignData
{
    ...
    public object NewDialogStatic => NewDialogStaticViewModel.DesignInstance;
    public object NewDialog1Static => NewDialog1StaticViewModel.DesignInstance;
    public object NewDialog2Static => NewDialog2StaticViewModel.DesignInstance;
